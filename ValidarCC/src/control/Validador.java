...
public class Validador {
    ...
    public int VISA = 0;
    public int MASTERCARD = 1;
    public int AMERICAN_EXPRESS = 2;
    public int EN_ROUTE = 3;
    public int DINERS_CLUB = 4;

    public final String[] cardNames = { "Visa", "Mastercard",
    ...
    @WebMethod
    public boolean validCC(@WebParam(name="numero") String number) throws Exception {
        int CardID;
     ...
     */
    @WebMethod
    public int getCardID(@WebParam(name="idcartao")String number) {
        int valid = INVALID;
    ...
    @WebMethod
    public boolean isNumber(@WebParam(name="n") String n) {
        try {
    ...
    @WebMethod
    public String getCardName(@WebParam(name="bandeira") int id) {
        return (id > -1 && id < cardNames.length ? cardNames[id] : "");
    }

    @WebMethod
    public boolean validCCNumber(@WebParam(name="validacao") String n) {
        try {
            /*
